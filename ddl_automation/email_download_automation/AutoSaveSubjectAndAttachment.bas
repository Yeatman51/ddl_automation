...
Sub AutoSaveSubjectAndAttachment()
...
Attachments.Item(i).SaveAsFile FolderPath & "\" & Format(Email.Subject, "") & Attachments.Item(i).FileName & ".pdf" 'Save attachment to the Folder Path using naming convention: Email's Received Time - Attachment's File Name

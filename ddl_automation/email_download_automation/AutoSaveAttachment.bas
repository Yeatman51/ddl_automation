...
FolderPath = "S:\Scans\DDL name split"
...
Attachments.Item(i).SaveAsFile FolderPath & "\" & Attachments.Item(i).FileName & ".pdf" 'Save attachment to the Folder Path using naming convention: Email's Received Time - Attachment's File Name

...
Sub AutoSaveBodyTextAttachments()
...
FolderPath = "S:\Scans\DDL Email Download" 'Default create Attachments Folder on Desktop. You can update the FolderPath to somewhere else.
...
Attachments.Item(i).SaveAsFile FolderPath & "\" & Format(Email.Body, "") & ".pdf" 'Save attachment to the Folder Path using naming convention: Email's Received Time - Attachment's File Name

...
# data table
# Matching value text
   if d.find_element(by=By.LINK_TEXT, value=f'{ddl1}'):
      d.find_element(by=By.LINK_TEXT, value=f'{ddl1}').click()
      time.sleep(3)
# export
      if d.find_element(by=By.LINK_TEXT, value='Export'):
...
# run report
         ...
         print(f'Downloaded {ddl1} from {date}')
         time.sleep(12)
# home
      else: 
         d.find_element(by=By.ID, value='j_idt40:j_idt42').click()
         time.sleep(3)
         print(f'Error Missing {ddl1} from {date}')
...
# data table
# Matching value text
   if d.find_element(by=By.LINK_TEXT, value=f'{ddl2}'):
...
# run report
         d.find_element(by=By.ID, value='intempconnect-data-builder-form:runBtn').click()
         print(f'Downloaded {ddl2} from {date}')
         time.sleep(12)
# home
      else: 
         d.find_element(by=By.ID, value='j_idt40:j_idt42').click()
         time.sleep(3)
         print(f'Error Missing {ddl2} from {date}')
...
# data table
# Matching value text
   if d.find_element(by=By.LINK_TEXT, value=f'{ddl3}'):
...
# run report
         d.find_element(by=By.ID, value='intempconnect-data-builder-form:runBtn').click()
         print(f'Downloaded {ddl3} from {date}')
         time.sleep(12)
# home
      else: 
         d.find_element(by=By.ID, value='j_idt40:j_idt42').click()
         time.sleep(3)
         print(f'Error Missing {ddl3} from {date}')
...
# data table
# Matching value text
   if d.find_element(by=By.LINK_TEXT, value=f'{ddl4}'):
...
# run report
         d.find_element(by=By.ID, value='intempconnect-data-builder-form:runBtn').click()
         print(f'Downloaded {ddl4} from {date}')
         time.sleep(12)
# home
      else: 
         d.find_element(by=By.ID, value='j_idt40:j_idt42').click()
         time.sleep(3)
         print(f'Error Missing {ddl4} from {date}')
